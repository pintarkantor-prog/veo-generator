...
# ==============================================================================
# Database link foto tetap terjaga untuk otomatisasi di balik layar.
LINK_REFERENSI = {
        ...
        for item in active_scenes:
            ...
            for idx, c in enumerate(all_chars_list):
                if c['name'].lower() in vis_lower:
                    ...
                    dna_injection += f"STRICT CHARACTER IDENTITY: Render {c['name']} using the exact human facial features shown in image reference link #{idx+1}. "
