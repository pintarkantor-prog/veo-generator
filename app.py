...
def tampilkan_ai_lab():
    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            ...
            "🌍 Diorama Masjid": {
                "Kota Botol & Kaleng (Recycled City)": "A detailed miniature architectural model constructed from orderly layers of recycled plastic bottles and geometric soda can elements, featuring vibrant multi-color RGB LED installations that shine through the translucent plastic and metallic surfaces to create a futuristic cyberpunk vibe, including tiny roads made of black rubber and small plastic-cap street lamps.",                "Masjidil Haram (Ka'bah & Mewah)": "A monumental architectural diorama of Masjidil Haram, presented as a large-scale museum exhibit. The colossal Ka'bah is at the center with a gigantic, meticulously draped real black cloth, adorned with sparkling white crystal tiles and warm gold LED calligraphy. The vast marble courtyard (Mataf) is brightly illuminated with thousands of cold-white LED lights, featuring tiny miniature pilgrims walking around the complex. The towering minarets have glowing green tips. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive elements look like colossal royal architecture.",
                "Masjid Nabawi (Payung & Green Dome)": "A detailed miniature of Masjid Nabawi, featuring a vibrant Green Dome brightly lit from within, iconic courtyard umbrellas with edges traced by warm white LED strips, hundreds of small LED street lamps along polished marble paths, and tiny palm trees.",
                "Masjid Al-Aqsa (Dome of the Rock)": "A detailed miniature of the Dome of the Rock, featuring a shimmering gold dome illuminated by warm-white LEDs, surrounded by small ancient olive trees and tiny stone pathways on a realistic rocky base with amber LED accents.",
                "Kabah (Mystical Diamond Glow)": "A detailed miniature of the Ka'bah, constructed from black Kiswah-style cloth segments with integrated diamond-like crystalline fibers that sparkle, featuring raised 24k gold calligraphy with warm-white and cool-blue LED pulsing light effects.",
                "Kabah (Mystical Diamond & Pilar Glow)": "A detailed miniature of the Ka'bah with sparkling crystalline black cloth and glowing gold calligraphy, surrounded by concentric arcades of small polished white marble columns illuminated by cool-white and gold LED installations.",
                "Pasukan Diorama Kabah (Mystic Macro Exhibit)": "A detailed miniature circular exhibit featuring a central black Ka'bah with glowing gold calligraphy, surrounded by four concentric rings of pillars made of teak wood, organic leaves, grass turf, and mixed exotic fruits, all integrated with linear cool-white LED light shows.",
                "Terapung di Danau (RGB Reflection)": "A detailed miniature mosque on a wooden platform situated on a calm resin lake, featuring a courtyard filled with glowing LED lotus flowers and lily pads, with the water surface acting as a dark mirror reflecting the vibrant RGB lights of the architecture.",
                "Diorama Mewah (Kubah Kuning & Air Terjun)": "A detailed miniature mosque featuring a sparkling polished yellow-brass dome and white stone-textured walls with RGB LED lights, with a courtyard containing a multi-tiered fountain and small wooden horse-drawn carriages on a paved stone floor.",
                "Diorama Organik (Refleksi Air & Neon)": "A detailed miniature mosque constructed from translucent soap segments that glisten with neon blue and purple LED backlighting, situated on a circular mirror-like reflection pool with small fiber-optic lights sparkling like fireflies in the garden.",
                ...
                "Tebing Karang & Masjid Cangkang (Ocean Neon)": "A detailed seaside miniature featuring a mosque made of sea shells on a rocky stone cliff, with rainbow LED fiber optics illuminating the waves and white sand courtyard with tiny dried corals.",
                "Hutan Rimba & Masjid Kayu Tua (Mystical Forest)": "A detailed jungle miniature featuring a mosque made of weathered bark and twigs hidden among ferns, with vibrant violet and lime LED lights glowing from the floor and windows.",
                "Gurun Pasir & Masjid Rempah (Sahara Gold)": "A detailed desert miniature with a mosque constructed from cinnamon sticks and orange peels on dunes of turmeric and sand, illuminated by warm amber and red LED lights near a small oasis.",
                ...
                "Diorama Modern (Geometric & RGB Strips)": "A detailed modern minimalist mosque with clean geometric white architecture and a silver-painted dome, featuring dynamic RGB LED strips tracing the structure edges and paths with abstract yard sculptures."
             }
        }
