...
def tampilkan_ai_lab():
    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            "🕌 Miniatur Masjid": {
                "Pure Bubblegum Pop": "A cute mosque diorama made entirely of soft, glossy edible-like materials. The walls are crafted from thick pink bubblegum sheets and smooth turquoise taffy. The main dome is a giant, translucent strawberry-flavored jelly globe, glowing from within with twinkling fiber-optic star lights. Every pillar is a striped peppermint candy cane, and the entrance arches are decorated with flickering multi-colored gummy bear-style LED lights, creating a vibrant, sugary toy atmosphere.",
                "Lollipop Glaze": "A standalone mosque building constructed from hardened colorful swirl lollipops and glossy sugar glaze. Featuring a dome made of semi-transparent yellow lemon-drop candy with a warm internal glow, while the minarets are tall sticks of rock candy. The entire structure is lined with tiny, multi-colored sugar-coated LED beads that flicker like dancing sprinkles.",
                "Cotton Candy Cloud": "A fluffy mosque object made of dense, vibrant pink and blue cotton candy textures with a glossy syrup finish. The dome is a large, glowing marshmallow ball that emits a soft yellow light, and the arches are lined with flickering neon-colored jelly-lace lights, giving it a soft but intense colorful pop-art look.",
                "Gummy Kingdom": "A mosque structure built from translucent red and green gummy-bear gelatin blocks. The main dome is a large, glossy purple grape-jelly sphere that houses warm yellow glowing crescent moons inside. The entrance is framed by rows of flickering multi-colored rainbow-belt candy lights that create a magical, delicious neon glow.",
                "Crystal Candy": "A monumental, large-scale 1-meter mosque diorama built entirely from millions of glossy pink bubblegum pieces and turquoise taffy blocks. The architecture looks massive and grand, with tiny detailed sugar-texture patterns that suggest a giant scale. The main dome is a colossal, translucent strawberry jelly sphere filled with a vast galaxy of thousands of twinkling fiber-optic star lights. Every entrance arch is lined with hundreds of tiny, flickering multi-colored sugar-drop LEDs. The shot is a straight-on, eye-level view of the massive candy building, showing its immense size and intricate sugary craftsmanship against a dark background, making the building look like a giant glowing sugary cathedral.",
                ...
                "Stik Es Krim & Kristal (Rainbow LED)": "A detailed miniature mosque constructed from orderly structural wooden ice cream sticks, featuring embossed gold calligraphy and rainbow LED lighting glowing through large crystal-bead windows.",
                ...
                "Kulit Jeruk & Buah (Citrus Fresh)": "A detailed miniature mosque constructed from sun-dried citrus zest plates, featuring intricate patterns carved into the organic facade with powerful warm LED installations glowing from the interior.",
                "Batok Kelapa & Nanas (Tropical Fruit)": "A detailed miniature mosque constructed from polished coconut shell structures and textured pineapple skin plates, featuring a golden dome and green LED installations.",
                "Kulit Semangka (Eco-Green)": "A detailed miniature mosque constructed from emerald-green watermelon rinds, featuring arched windows with glowing emerald LED installations.",
                "Emas & Marmer (Royal Palace)": "A detailed miniature mosque constructed from gold-plated segments and polished white marble slabs, featuring 24k gold leaf calligraphy, emerald-encrusted windows.",
                "Kristal & Berlian (Diamond Glow)": "A detailed miniature mosque constructed from Swarovski-style crystalline structures and silver filigree, featuring blue LED installations refracting through glass facets.",
                ...
                "Safir & Platinum (Futuristic Luxury)": "A detailed miniature mosque constructed from platinum-finished metal segments and deep sapphire-colored glass panels, featuring neon-white LED installations along the arches and domes.",
                "Serabut Kelapa & LED Rainbow (Rustic-Neon)": "A detailed miniature mosque constructed from woven golden-brown coconut fiber, featuring gold calligraphy and vibrant multi-color LED installations in cyan, magenta, and lime glowing through the fibrous walls.",
                ...
                "Batok Kelapa & LED Crystal (Tropical Diamond)": "A detailed miniature mosque constructed from polished dark coconut shells, featuring domes with sparkling rainbow LED fiber optics and gold-painted calligraphy.",
                "Daun Kering (LED Warm)": "A detailed miniature mosque constructed from structural segments of dried organic leaves, featuring warm LED installations integrated into the structure.",
                "Kayu (LED Amber)": "A detailed miniature mosque constructed from woven bamboo structures, featuring amber-colored LED installations that cast dramatic shadows through the fibrous walls.",
                "Daun Pisang (Traditional)": "A detailed miniature mosque crafted from fresh and dried banana leaf segments, featuring yellow LED installations glowing through organic green and brown textures.",
                "Buah Melon (Carved Art)": "A detailed miniature mosque featuring walls with green melon rind patterns, glowing with lime-green LED installations from the interior.",
                "Buah Naga (Exotic Pink)": "A detailed miniature mosque featuring a vibrant pink scale-textured facade like a dragon fruit, with magenta LED installations highlighting the textures.",
                "Koran Bekas (Paper Craft)": "A detailed miniature mosque built from recycled newsprint segments showing hints of printed typography, illuminated by RGB LED installations.",
                "Pecahan Kaca (Mosaic)": "A detailed miniature mosque constructed from shimmering mosaic glass panels, featuring cool-blue and white LED installations creating a sparkling crystalline effect.",
                ...
                "Kristal (LED Neon)": "A detailed miniature mosque constructed from glistening crystalline structures, featuring neon blue and purple LED installations glowing through glass-like walls.",
                ...
                "Jerami (Rustic Straw)": "A detailed miniature mosque constructed from woven golden straw and hay, featuring flickering warm yellow LED installations inside.",
                ...
                "Serut Kayu (Wood Shavings)": "A detailed miniature mosque featuring walls made of curly light-colored timber shavings, illuminated by amber LED installations glowing through the curly textures.",
                "Cangkang Telur (Mosaic Shell)": "A detailed miniature mosque constructed from white and brown eggshell mosaic panels, glowing with white LED installations reflecting off the shell textures.",
                "Bunga & Daun (Floral Garden)": "A detailed miniature mosque covered in colorful blooming flowers and fresh green leaves, glowing with multi-color RGB LED installations.",
                "Kayu Jati & Daun (Forest Rustic)": "A detailed miniature mosque built from dark polished teak wood with fresh green leaf patterns on the dome, illuminated by warm amber LED installations.",
                ...
                "Kulit Jagung & Biji-bijian (Harvest)": "A detailed miniature mosque crafted from dried corn husks and seed mosaic patterns, glowing with warm orange LED installations.",
                ...
                "Daun Pisang & Serabut Kelapa (Rustic Nature)": "A detailed miniature mosque featuring a dome made of intricately layered fresh and dried banana leaf segments, with a main traditional structure and minarets constructed from woven golden-brown coconut fiber and polished dark polished teak wood structures accented, glowing intensely with powerful yellow LED installations through the leaf and fibrous walls, and a mossy green traditional landscape base.",
                "Kristal & Kardus (Cyber-Eco)": "A detailed miniature mosque featuring a central dome made of shimmering Swarovski-style crystals and minarets constructed from raw industrial cardboard layers, with cool-blue LED light refracting through the crystal while warm amber LED glows through the cardboard gaps.",
                "Buah Naga & Akrilik (Exotic Modern)": "A detailed miniature mosque with walls featuring the vibrant pink scale-texture of dragon fruit and a dome made of translucent sandblasted acrylic, illuminated by magenta and white LED strips tracing the organic and geometric edges.",
                "Biji Kopi & Emas (Luxury Aroma)": "A detailed miniature mosque constructed from dark roasted coffee beans with 24k gold-plated arches and windows, featuring warm orange LED backlighting that highlights the bean textures and gold reflections.",
                "Kulit Semangka & Kaca (Emerald Mosaic)": "A detailed miniature mosque featuring a dome of emerald-green watermelon rind and walls made of shimmering mosaic glass shards, glowing with emerald and white LED installations from the interior.",
                "Botol Plastik & Kayu Jati (Recycled Heritage)": "A detailed miniature mosque featuring a dome made of translucent recycled blue plastic bottle bottoms and a main structure of dark aged teak wood, with pulsing RGB LED lights glowing through the plastic and wood carvings.",
                "Permen Yupi & Sedotan (Neon Candy)": "A detailed miniature mosque constructed from translucent gummy material segments and towers made of intertwined colorful plastic straws, featuring vibrant neon-green LED light shining through the gelatinous and tubular structures.",
                "Ijuk & Logam Krom (Rustic Cyber)": "A detailed miniature mosque featuring a roof of woven black sugar palm fiber (ijuk) and a facade of polished mirror-like chrome plates, with violet LED installations reflecting off the metal and glowing through the fiber.",
                "Daun Kering & Akrilik (Pearl Oasis)": "A detailed miniature mosque featuring a dome made of finely crushed white eggshell mosaic and walls constructed from crystal-clear acrylic panels, illuminated by soft warm-gold LED light that refracts through the acrylic while creating a shimmering mother-of-pearl effect on the eggshell textures, with a base of white polished pebbles.",
                ...
                "Sabun & Logam (Glimmering Jewel)": "A detailed miniature mosque constructed from translucent soap segments carved into precise geometric forms resembling large colorful gemstones, with minarets made of intertwined silver-plated wire and metal filigree, illuminated by dynamic RGB LED installations that create shifting, multi-color internal reflections and a shimmering effect on the soap facade.",
                "Karet Gelang & Kaca (Elastic Cyber)": "A detailed miniature mosque constructed from intertwined networks of colorful rubber bands and walls made of shimmering mosaic glass panels, glowing intensely with vibrant multi-color RGB LED lights woven through the elastic structure and reflecting off the glass textures, creating a spectacular cyberpunk light show.",
                "Sedotan & Biji-bijian (Geometric Harvest)": "A detailed miniature mosque constructed from intertwined colorful plastic straws and intricate seed mosaic patterns of corn, rice, and beans, featuring a dome and minarets that glow with dynamic multi-color RGB LED light shining through the tubular and organic structures.",
                "Perca Kain & Benang (Textile Craft)": "A detailed miniature mosque constructed from batik fabric patterns and yarn embroidery installations, glowing with dynamic multi-color RGB LED lights intensely through the textile textures on a felt-textured landscape with silver-plated perimeter walls.",
                "Lidi & Koran (Rustic Paper)": "A detailed miniature mosque featuring a dome and minarets constructed from thousands of vertical coconut leaf sticks (lidi) bundled together, with walls made of orderly layers of recycled newsprint showing hints of printed typography, illuminated by warm amber LED light glowing intensely through the gaps between the sticks and the paper textures.",
                "Lidi & Daun Kering (Autumn Village)": "A detailed miniature mosque featuring a dome of layered dried brown leaves and a main structure constructed from woven coconut leaf sticks (lidi) and dark wood, with internal warm yellow LED installations casting dramatic linear shadows through the lidi walls onto a dry-grass landscape.",
                "Lidi & Kardus (Industrial Craft)": "A detailed miniature mosque constructed from industrial-grade cardboard layers with a facade and arched entrances accented by intricate patterns of coconut leaf sticks (lidi), illuminated by pulsing orange LED installations that highlight the corrugated cardboard edges and the fibrous sticks.",
                "Lidi & Batok Kelapa (Tropical Native)": "A detailed miniature mosque featuring a dome of polished dark coconut shells and minarets made of bundled coconut leaf sticks (lidi), with warm amber LED installations glowing through the coconut fiber and reflecting off the smooth shell surfaces.",
                "Lidi & Kain Perca (Textile Rustic)": "A detailed miniature mosque constructed from woven coconut leaf sticks (lidi) as the main frame and walls covered in colorful batik fabric patches, with multi-color LED installations glowing from the interior, shining through both the fabric and the stick lattice.",
                "Lidi & Biji-bijian (Seed Mosaic)": "A detailed miniature mosque featuring walls made of green mung bean and red kidney bean mosaics, with a dome and minarets intricately constructed from coconut leaf sticks (lidi), illuminated by lime-green and amber LED installations.",
                "Serabut Kelapa & Daun (Rustic Nature)": "A detailed miniature mosque featuring a dome made of intricately layered fresh and dried banana leaf segments, with a main traditional structure and minarets constructed from woven golden-brown coconut fiber and polished dark polished teak wood structures accented, glowing intensely with powerful yellow LED installations through the leaf and fibrous walls, and a mossy green traditional landscape base.",
                "Daun Kering & Koran (Typography Gold)": "A detailed miniature mosque constructed from orderly layers of dried newsprint segments showing hints of printed black typography, with a dome and minarets made of finely crushed white eggshell mosaic plated elements, illuminated by internal amber LED light glowing through the paper gaps and creating a mother-of-pearl effect on the eggshells.",
                ...
                "Koran & Sedotan (Geometric Typography)": "A detailed miniature mosque constructed from orderly layers of dried newsprint segments showing hints of printed black typography, with minarets made of intertwined colorful plastic straws, illuminated by pulsing multi-color RGB LED installations that trace the paper gaps and tubular structures.",
                "Serabut Kelapa & Kaca (Glimmering Rustic)": "A detailed miniature mosque constructed from woven golden-brown coconut fiber and walls made of shimmering mosaic glass panels, with dynamic multi-color RGB LED installations woven through the elastic structure and reflecting off the glass textures, creating a spectacular cyberpunk light show.",
                "Daun Kering & Kain Perca (Textile Rustic)": "A detailed miniature mosque featuring a dome of layered dried brown leaves and a main structure covered in colorful batik fabric patches, with multi-color LED installations glowing from the interior, shining through both the leaf and fabric lattice.",
                ...
                "Sedotan & Biji-bijian (Geometric Harvest)": "A detailed miniature mosque constructed from intertwined colorful plastic straws and intricate seed mosaic patterns of corn, rice, and beans, featuring a dome and minarets that glow with dynamic multi-color RGB LED light shining through the tubular and organic structures.",
                "Arang & Lidi (Black Charcoal)": "A detailed miniature mosque constructed from rough black charcoal blocks for the walls and thousands of vertical coconut leaf sticks (lidi) for the dome, with glowing amber LED installations flickering intensely through the porous charcoal and stick gaps.",
                "Kulit Salak & Bambu (Snake-Skin Rustic)": "A detailed miniature mosque featuring a dome covered in overlapping dark brown snake-fruit (salak) skin scales and a main structure made of thin woven bamboo strips, illuminated by warm yellow LED installations that highlight the scaly and fibrous textures.",
                "Kancing Baju & Benang (Button Craft)": "A detailed miniature mosque featuring walls made of thousands of interlocking colorful plastic buttons and a dome intricately wrapped in vibrant embroidery yarn, with multi-color RGB LED lights glowing through the button holes and translucent materials.",
                "Daun Jati Kering & Serabut (Brown Autumn)": "A detailed miniature mosque constructed from large dried teak leaves for the roof and golden-brown coconut fiber for the walls, featuring internal warm orange LED installations that cast dramatic organic shadows through the fibrous textures.",
                "Sedotan Hitam & Silver (Cyber Industrial)": "A detailed miniature mosque built from thousands of matte black plastic straws bundled together, featuring dome accents made of recycled silver-colored snack foil, illuminated by neon-purple and white LED light tracing the tubular lines.",
                "Biji Jagung & Kulit Jagung (Harvest Gold)": "A detailed miniature mosque featuring a dome made of a golden corn-cob mosaic and walls wrapped in dried corn husks, with warm-white LED installations glowing intensely through the translucent husks and seed gaps.",
                "Koran & Tutup Galon (Recycled Blue)": "A detailed miniature mosque featuring a dome made of translucent blue plastic gallon caps and walls of layered recycled newsprint, with cool-white LED installations glowing through the blue plastic and the printed typography textures.",
                "Sapu Lidi & Tali Rami (Ethnic Fiber)": "A detailed miniature mosque constructed from bundled coconut leaf sticks (lidi) and wrapped in thick hemp rope, featuring a rustic dome with internal warm amber LED installations that highlight the complex textures of the rope and sticks."
            },
