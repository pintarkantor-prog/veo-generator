    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            "🕌 Miniatur Masjid": {
                ...
                "Buah Melon": "A monumental 1-meter standalone mosque object made of glossy cantaloupe melon and translucent green rind. Featuring a colossal strawberry-jelly dome filled with thousands of twinkling multi-colored fiber-optic star lights. All arches are lined with flickering multi-colored sugar-drop LEDs and vibrant RGB neon strips. High detail, vibrant colors, clear object edges.",
                "Buah Strawberry": "A monumental 1-meter standalone mosque object made of pink strawberry-jelly and glossy whipped cream. Featuring a colossal translucent strawberry-pulp dome with internal rotating multi-colored LED wash lights. All arches are outlined with intense flickering rainbow fairy lights and vibrant RGB neon tubing. High detail, vibrant colors, clear object edges.",
                "Buah Semangka": "A monumental 1-meter standalone mosque object made of vibrant red watermelon cubes and glossy green-striped rind blocks. Featuring a colossal semi-transparent red gelatin dome with thousands of twinkling multi-colored fiber-optic star lights. All pillars are wrapped in intensely flickering colorful LED fairy lights and vibrant RGB neon strips. High detail, vibrant colors, clear object edges.",
                "Buah Naga": "A monumental 1-meter standalone mosque object made of high-gloss white dragonfruit with black seeds and bright magenta rind. Featuring a colossal dome with powerful colorful fiber-optic lines swirling inside. The entire structure is framed by intense flickering colorful RGB neon tubing and sugar-fairy lights. High detail, vibrant colors, clear object edges."       
            },
