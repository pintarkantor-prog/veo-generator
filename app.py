    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            ...
            "🌍 Diorama Masjid": {
                ...
                "Masjidil Haram (Ka'bah & Mewah)": "A detailed miniature diorama of Masjidil Haram built on a polished marble base. The small-scale Ka'bah is at the center draped in real black Kiswah cloth with gold LED calligraphy, surrounded by a white stone Mataf courtyard illuminated by thousands of tiny cold-white LED pixels and miniature figure silhouettes.",
                ...
                "Diorama Modern (Geometric & RGB Strips)": "A detailed modern minimalist mosque with clean geometric white architecture and a silver-painted dome, featuring dynamic RGB LED strips tracing the structure edges and tiny abstract yard sculptures."
            }
        }
