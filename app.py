    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            "🕌 Miniatur Masjid": {
                ...
                "Campuran Kayu & LED RGB": "Miniature a colossal architectural mosque built from massive recycled wood structures, featuring intricate gold Arabic calligraphy around the gigantic dome and vibrant multi-color LED strips glowing from the large windows. The vast yard is decorated with stone gravel paths and grand street lamps.",
                "Akrilik & Logam (Neon Glow)": "Miniature a colossal modern architectural mosque constructed from massive clear acrylic panels and heavy scrap metal structures, featuring gigantic sandblasted calligraphy on the walls and pulsing RGB LED lights that illuminate the huge interior. The vast yard is decorated with large silver boulders and grand glowing LED bushes.",
                "Bambu & Batok Kelapa (Vibrant LED)": "Miniature a colossal traditional architectural mosque constructed from massive woven bamboo structures and large polished coconut shell panels, featuring gigantic hand-painted gold calligraphy and vibrant colorful LED installations tracing the huge arches. The vast yard is decorated with natural landscape moss and high bamboo perimeter walls.",
                "Stik Es Krim & Kristal (Rainbow LED)": "Miniature a colossal architectural mosque built from massive structural wooden planks resembling ice cream sticks, featuring gigantic embossed gold calligraphy and rainbow LED lighting glowing through large crystal-bead windows. The vast yard is decorated with white sand and grand flower gardens.",
                "Kardus & Barang Bekas (Electric Glow)": "Miniature a colossal architectural mosque constructed from massive layers of recycled industrial cardboard and heavy electronics, featuring gigantic glowing neon calligraphy and towering multi-colored fiber optic light installations on the minarets. The vast yard is decorated with large colorful wire sculptures and monumental metallic structures.",
                "Pelangi (Rainbow Village)": "Miniature a colossal architectural mosque painted in vibrant, cheerful rainbow colors across its massive structure. Features multiple gigantic domes and huge windows illuminated with powerful LED installations. The vast yard is decorated with large colorful boulders and monumental animal-themed sculptures.",
                "Kerajaan Awan (Cloud Kingdom)": "Miniature a colossal architectural mosque inspired by majestic fantasy realms, constructed from massive structural materials resembling gigantic fluffy clouds and ethereal textures. Features huge star and moon shaped windows. The vast yard is decorated with large glowing crystalline stars and monumental cloud-like formations.",
                "Kastil Balok (Block Castle)": "Miniature a colossal architectural mosque built from massive colorful structural building blocks. Features towering blocky minarets and a gigantic central dome constructed from huge interlocking architectural bricks. The vast yard is decorated with monumental block-shaped sculptures and full-sized futuristic vehicles.",
                "Hutan Ajaib (Magic Forest)": "Miniature a colossal architectural mosque constructed from massive ancient timber and living moss, integrated into a vast primeval forest. Features gigantic animal-themed stone carvings on the walls and powerful glowing ethereal light installations. The vast yard is decorated with huge glowing fungal structures and monumental mythical creature statues.",
                "Kulit Jeruk & Buah (Citrus Fresh)": "Miniature a colossal architectural mosque featuring massive structural walls with the organic texture of citrus zest, constructed from gigantic sun-dried organic plates. Features huge intricate patterns carved into the monumental facade with powerful LED installations glowing from the large interior. The vast yard is decorated with monumental spice-shaped sculptures and high aromatic timber perimeter walls.",
                "Biji-Bijian & Rempah (Spice & Grain)": "Miniature a colossal architectural mosque featuring massive mosaic walls constructed from gigantic structural elements resembling pumpkin seeds, coffee beans, and corn. Features huge complex geometric patterns across the monumental facade with warm, powerful LED installations. The vast yard is decorated with large spherical stone sculptures and grand wooden architectural pavilions.",
                "Batok Kelapa & Nanas (Tropical Fruit)": "Miniature a colossal tropical architectural mosque constructed from massive polished coconut shell structures and gigantic textured organic plates resembling pineapple skins. Features a huge textured golden dome and powerful green LED installations. The vast yard is decorated with large exotic stone seeds and grand architectural bamboo bridges.",
                "Kulit Semangka (Eco-Green)": "Miniature a colossal bio-architectural mosque featuring massive structural walls with the texture of thick, emerald-green watermelon rinds. Features gigantic arched windows with powerful glowing emerald LED installations from the huge interior. The vast yard is decorated with large stone boulders and grand architectural water lily lakes.",
                "Emas & Marmer (Royal Palace)": "Miniature a colossal architectural royal mosque constructed from massive gold-plated structural segments and monumental polished white marble slabs, featuring gigantic 24k gold leaf calligraphy and huge emerald-encrusted windows. The vast yard is made of smooth obsidian stone with grand golden fountain installations and towering cypress trees.",
                "Kristal & Berlian (Diamond Glow)": "Miniature a colossal architectural mosque constructed from massive Swarovski-style crystalline structures and monumental silver filigree work, featuring powerful blue LED installations that refract through gigantic glass facets. The vast yard is decorated with crushed diamond-like sand and grand crystal floral sculptures.",
                "Kayu Jati & Gading (Imperial Heritage)": "Miniature a colossal imperial architectural mosque built from massive dark aged teak wood structures with gigantic ivory-white inlays, featuring huge hand-carved Arabic motifs and powerful warm amber LED backlighting. The vast yard is covered in premium velvet-textured landscape with high silver-plated perimeter walls.",
                "Safir & Platinum (Futuristic Luxury)": "Miniature a colossal futuristic architectural mosque constructed from massive platinum-finished metal segments and gigantic deep sapphire-colored glass panels, featuring powerful glowing neon-white LED installations along the huge arches and domes. The vast yard is decorated with large polished chrome boulders and monumental futuristic glass tree structures.",
                "Sutra & Mutiara (Elegant Silk)": "Miniature a colossal architectural mosque constructed from massive structural white silk panels and gigantic mother-of-pearl slabs, featuring huge pearl-encrusted minarets and powerful glowing golden LED installations. The vast yard is made of monumental satin-finished architectural flooring and grand pearl-stone gardens.",
                "Serabut Kelapa & LED Rainbow (Rustic-Neon)": "Miniature a colossal architectural mosque constructed from massive woven golden-brown coconut fiber structures, featuring gigantic gold calligraphy and vibrant multi-color LED installations (Cyan, Magenta, and Lime) glowing through the huge fibrous walls. The vast yard is decorated with large white sea shell paths and high bamboo perimeter walls.",
                "Mosaik Kulit Buah & LED Glow (Citrus Imperial)": "Miniature a colossal architectural mosque featuring massive mosaic patterns constructed from gigantic dried orange and lemon peel segments, with powerful emerald-green LED installations glowing from the huge arched windows and monumental gold-leaf details on the minarets. The vast yard is decorated with large star-shaped stone sculptures and grand aromatic timber structures.",
                "Kelopak Bunga & LED Sapphire (Floral Majesty)": "Miniature a colossal architectural mosque constructed from massive structural segments resembling deep-red rose petals, featuring powerful sapphire-blue LED installations hidden within the gigantic floral layers for a mystical glow and monumental gold-embossed calligraphy. The vast yard is made of smooth black stone boulders and grand jasmine-themed floral sculptures.",
                "Batok Kelapa & LED Crystal (Tropical Diamond)": "Miniature a colossal, heavy architectural mosque constructed from massive polished dark coconut shell structures, featuring gigantic domes with sparkling rainbow LED fiber optics that create a huge starry effect and monumental gold-painted calligraphy. The vast yard is decorated with white sand and towering architectural palm tree structures made of high-grade fiber.",
                "Daun Kering (LED Warm)": "Miniature a colossal architectural mosque constructed from massive structural segments resembling dried organic leaves, featuring powerful warm LED installations integrated into the gigantic structure. The vast yard is decorated with grand dry grass landscapes, large stone boulders, and high wooden perimeter walls.",
                "Bunga (LED RGB)": "Miniature a colossal architectural mosque entirely covered in gigantic vibrant floral installations with powerful multi-colored LED strips glowing from the huge windows. The vast courtyard is lush with monumental rose gardens and a grand architectural water fountain.",
                "Kayu (LED Amber)": "Miniature a colossal architectural mosque constructed from massive woven bamboo structures with powerful amber-colored LED installations inside, casting huge dramatic shadows. The vast yard features monumental ancient trees and a grand stone-paved pathway leading to the gigantic entrance.",
                "Daun Pisang (Traditional)": "Miniature a colossal architectural mosque crafted from massive structural segments resembling fresh and dried banana leaves with gigantic organic green and brown textures. Decorated with powerful yellow LED installations inside. The vast yard features towering banana tree structures and high bamboo perimeter walls on a monumental mossy green landscape.",
                "Buah Melon (Carved Art)": "Miniature a colossal bio-architectural mosque featuring massive structural walls with the gigantic textured rind patterns of a green melon. Glowing with powerful lime-green LED installations from the huge interior. The vast courtyard is decorated with monumental floral stone carvings and a grand mint-green reflection lake.",
                "Buah Naga (Exotic Pink)": "Miniature a colossal architectural mosque featuring massive structural walls with the gigantic vibrant pink scale-textured facade of a dragon fruit. Features powerful magenta LED installations that highlight the monumental scale-like textures. The vast yard features gigantic exotic botanical structures and huge stretches of pinkish sand.",
                "Koran Bekas (Paper Craft)": "Miniature a colossal architectural mosque built from massive structural segments of recycled newsprint textures, showing gigantic hints of printed typography across its monumental facade. Illuminated by powerful RGB LED installations. The vast yard features towering paper-textured tree structures and grand architectural benches made of massive structural cardboard.",
                "Pecahan Kaca (Mosaic)": "Miniature a colossal architectural mosque constructed from massive shimmering mosaic glass panels. Featuring powerful cool-blue and white LED installations that create a gigantic sparkling crystalline effect across the monumental facade. The vast yard is decorated with large translucent glass boulders and a grand mirror-surfaced floor area.",
                "Botol Bekas (Recycled Plastic)": "Miniature a colossal architectural mosque constructed from massive structural segments of translucent recycled polymers and gigantic geometric cap-inspired elements. Glowing with powerful, vibrant multi-color RGB LED installations that shine through the huge plastic facades. The vast courtyard is decorated with monumental colorful floral sculptures and grand emerald-green synthetic landscapes.",
                "Kristal (LED Neon)": "Miniature a colossal architectural mosque constructed from massive glistening crystalline structures with powerful neon blue and purple LED installations. The vast base is decorated with large crystal boulders and a grand glass-surfaced reflection lake.",
                "Pasir (Sand Art)": "Miniature a colossal architectural mosque sculpted entirely from massive amounts of fine golden sand, featuring gigantic smooth domes and monumental architectural edges, glowing with powerful amber LED installations. The vast yard is a serene monumental desert landscape with large raked sand patterns and huge desert boulders.",
                "Bunga Matahari (Yellow Glow)": "Miniature a colossal architectural mosque entirely covered in gigantic vibrant yellow sunflower petals, with the massive dome featuring the dark seeded textures of a sunflower center. Glowing with powerful golden-yellow LED installations. The vast courtyard is decorated with monumental sunflower-themed floral structures and a grand yellow-stone architectural pathway.",
                "Jerami (Rustic Straw)": "Miniature a colossal rustic architectural mosque constructed from massive woven golden straw and hay structures, featuring gigantic intricate patterns with powerful warm yellow LED installations flickering inside. The vast yard features monumental haystack structures, high wooden perimeter walls, and a grand rustic atmosphere.",       
                "Roti (Bread Craft)": "Miniature a colossal architectural mosque constructed from massive structural segments of various baked bread and gigantic golden-brown crust panels, glowing with powerful warm orange LED installations from the huge windows. The vast courtyard is decorated with grand golden-grain pathways and monumental flour-dusted botanical structures.",       
                "Buah Jeruk (Citrus Fresh)": "Miniature a colossal architectural mosque crafted from massive structural segments of bright orange citrus peels and gigantic dried orange-slice windows, glowing with powerful orange and lime-green LED installations. The vast yard features towering citrus-themed botanical structures and large orange-colored stone boulders.",
                "Serut Kayu (Wood Shavings)": "Miniature a colossal architectural mosque featuring massive structural segments made of gigantic curly light-colored timber shavings, illuminated by powerful amber LED installations. The vast courtyard is decorated with grand architectural wooden benches, monumental pine tree structures, and a huge textured timber-dust landscape.",
                "Cangkang Telur (Mosaic Shell)": "Miniature a colossal architectural mosque constructed from massive structural segments of white and brown eggshell mosaic panels, glowing with powerful white LED installations. The vast yard features grand white stone-paved pathways and monumental botanical structures set in gigantic architectural containers.",
                "Bunga & Daun (Floral Garden)": "Miniature a colossal architectural mosque intricately covered in massive installations of colorful blooming flowers and gigantic fresh green leaves, glowing with powerful multi-color RGB LED installations. The vast yard features a monumental floral archway, grand green landscapes, and a huge stone-paved pathway.",
                "Kayu Jati & Daun (Forest Rustic)": "Miniature a colossal architectural mosque built from massive dark polished teak wood structures accented with gigantic fresh green leaf patterns on the dome, illuminated by powerful warm amber LED installations. The vast courtyard is decorated with monumental teak timber structures, large mossy boulders, and huge prehistoric forest ferns.",
                "Bambu & Janur (Traditional Art)": "Miniature a colossal architectural mosque constructed from massive yellow bamboo pillars and gigantic woven young coconut leaf (janur) segments, glowing with powerful yellow LED installations. The vast yard is decorated with monumental 'penjor' installations and a high architectural bamboo perimeter wall.",
                "Batu Kali & Lumut (Nature Zen)": "Miniature a colossal architectural mosque constructed from massive river stone boulders and gigantic patches of natural green moss, featuring powerful cool white LED installations glowing from the huge windows. The vast yard features a monumental flowing river stream and towering pine tree structures.",
                "Kulit Jagung & Biji-bijian (Harvest)": "Miniature a colossal architectural mosque crafted from massive structural segments of dried corn husks and gigantic mosaic patterns made of various seeds, glowing with powerful warm orange LED installations. The vast yard features monumental harvest structures and towering scarecrow-themed statues on a huge grain-textured landscape.",
                "Perca Kain & Benang (Textile Craft)": "Miniature a colossal architectural mosque constructed from massive structural segments of batik fabric patterns and gigantic yarn embroidery installations, glowing with powerful RGB LED lights from the huge interior. The vast courtyard is decorated with monumental floral textile sculptures and grand architectural seating structures on a monumental felt-textured landscape.",
                "Pelepah Pisang & Lidi (Village Vibes)": "Miniature a colossal rustic architectural mosque constructed from massive dried banana midrib structures and gigantic coconut leaf stick (lidi) installations, glowing with powerful warm amber LED lights. The vast yard features monumental traditional pavilion structures and huge clay-formed architectural vessels on a monumental dry-earth landscape.",
                "Donat (Glazed & Sprinkle)": "Miniature a colossal architectural mosque constructed from massive structural segments of stacked glazed donut forms with gigantic colorful sprinkles and icing textures, glowing with powerful warm pink LED installations. The vast courtyard is decorated with monumental spherical botanical structures and a grand sugar-powdered architectural pathway.",
                "Permen Warna-Warni (Hard Candy)": "Miniature a colossal architectural mosque constructed from massive structural segments of colorful hard candies and gigantic lollipop-inspired pillars, featuring a monumental glossy crystalline texture that reflects powerful multi-color RGB LED installations. The vast yard features high candy-cane architectural barriers and a grand rainbow-textured landscape.",
                "Permen Yupi (Gummy Texture)": "Miniature a colossal architectural mosque crafted from massive structural segments of various translucent gummy materials and gigantic gelatinous forms, glowing intensely with powerful RGB LED installations shining through the huge gummy facades. The vast yard features towering gummy-textured tree structures and a monumental soft-textured landscape base.",
                "Jelly & Puding (Translucent)": "Miniature a colossal architectural mosque constructed from massive translucent colorful jelly-like segments and gigantic structural pudding blocks, with powerful neon LED installations glowing beautifully through the huge wobbly material facades. The vast courtyard is decorated with large translucent crystal-like boulders and a grand syrup-textured reflection lake.",
                "Cokelat & Biskuit (Choco-Art)": "Miniature a colossal architectural mosque constructed from massive dark and milk chocolate structural segments with gigantic biscuit-textured roofing, glowing with powerful golden LED installations. The vast courtyard features monumental wafer-styled architectural benches and huge cocoa-powdered mountain landscapes.",
                "Marshmallow (Soft Cloud)": "Miniature a colossal architectural mosque constructed from massive white and pastel structural segments with gigantic marshmallow-like textures, glowing with powerful ethereal RGB LED installations. The vast yard is decorated with towering cotton-candy botanical structures and a huge white sugar-sand landscape.",
                "Menara Kaleng (Industrial Majesty)": "Miniature a colossal industrial mosque constructed from massive stacked silver metallic cylinders with gigantic domes made of structural translucent segments, featuring huge gold-leaf calligraphy and powerful emerald-green LED installations glowing through the massive gaps. The vast yard is decorated with monumental metallic gears, large copper structural elements, and towering glowing LED botanical installations.",
                "Lampion Plastik (Rainbow Recycle)": "Miniature a colossal architectural mosque constructed from massive structural segments of colorful translucent polymers and gigantic geometric recycled elements, featuring powerful rainbow LED installations that transform the monumental structure into a gigantic glowing lantern. The vast yard is decorated with grand multi-color stone-paved pathways and high architectural perimeter walls made of massive structural beams and industrial wire.",
                "Macaroon (Elegant Pastel)": "Miniature a colossal architectural mosque constructed from massive structural segments of stacked colorful macaroon-inspired disks, featuring monumental pastel-toned facades and powerful warm white LED installations. The vast courtyard is decorated with grand botanical sculptures with cream-like textures and a huge pastel-tiled architectural pathway.",
                "Biji Kopi (Dark Aroma)": "Miniature a colossal architectural mosque constructed from massive structural segments of dark roasted coffee bean textures, featuring a monumental rich brown facade and powerful warm orange LED installations. The vast courtyard is decorated with monumental architectural storage structures and grand dark-toned stone-paved pathways.",
                "Bungkus Snack (Snack Wrap Art)": "Miniature a colossal architectural mosque constructed from massive structural segments made of colorful recycled snack packaging, featuring a vibrant mosaic of yellow, red, and blue wrappers with gigantic brand graphics. The structure is illuminated by a powerful, dynamic multi-color RGB LED installation integrated throughout the facade, creating a spectacular glowing kaleidoscope effect. The vast yard features monumental botanical structures made of reflective metallic elements and grand multi-color stone-paved pathways under a dazzling light show.",
                "Sabun (Crystal Soap Art)": "Miniature a colossal architectural mosque constructed from massive translucent soap segments resembling giant colorful gemstones, featuring vibrant green, blue, and purple crystalline textures, glowing with dynamic RGB LED lights that create shifting, multi-color internal reflections throughout the wobbly facade. The vast yard is decorated with monumental gemstone-styled sculptures and grand stone-paved pathways under a dazzling light spectacle.",
                "Karet Gelang (Elastic Rubber Art)": "Miniature a colossal architectural mosque constructed from massive intertwined networks of gigantic colorful rubber bands, featuring intricate, stretched elastic textures that create complex geometric patterns across the facade, glowing intensely with powerful dynamic multi-color RGB LED lights woven through the rubber structure. The vast yard features monumental rubber-sculpture art installations and grand textured pathways under a dazzling light show."          
            },
