...
st.info("masih tahap ujicoba dulu... semangatsss yoow ❤️")
...
# --- 4. PARAMETER KUALITAS SUPRA-DETAIL (9:16 Optimized) ---
img_quality = (
    ...
    "no black bars, no letterbox, NO soft focus, NO blur, NO cartoonish flat colors, --ar 9:16"
)

vid_quality = (
    "9:16 vertical full-screen video, ultra-vivid 4k clarity, high frame rate 60fps, "
    "vivid color fidelity, vibrant natural environments, emerald foliage, deep blue sky tones, "
...
if st.button("🚀 BUAT PROMPT", type="primary"):
    ...
    if not filled_scenes:
        ...
        for scene in filled_scenes:
            ...
            final_vid = (
                f"Generate a supra-detailed vivid video for Scene {i}. 9:16 vertical full-screen. "
                f"Focus on environment colors and sharp character textures. "
...
st.sidebar.markdown("---")
st.sidebar.caption("PINTAR MEDIA Storyboard v3.2 - Flexible & Sharp")
