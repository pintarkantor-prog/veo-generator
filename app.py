...
def tampilkan_ai_lab():
    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            "🕌 Miniatur Masjid": {
                "Kaleng Alumunium (Metallic Neon)": "Miniature a colossal architectural mosque built with gigantic industrial-grade aluminum plates and recycled metallic structure. The massive dome and towering minarets feature embossed Arabic calligraphy glowing with pulsing RGB neon. The structure stands as a titanic futuristic landmark, its huge metallic walls reflecting brilliant neon lights. The vast courtyard contains intricate metallic wire sculptures and paths of shimmering silver ore, all built to a monumental scale.",
                "Kristal Botol (Aquatic Glow)": "Miniature a monumental architectural mosque constructed from massive layers of clear recycled plastic bottles. The colossal structure features gold calligraphy on its transparent surfaces, with vibrant blue and cyan LED lights refracting through the gigantic crystalline walls. The vast yard is decorated with large shards of clear plastic resembling blocks of ice and grand LED-lit fountains.",
