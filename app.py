...
def tampilkan_ai_lab():
    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            "🕌 Miniatur Masjid": {
                "Kaleng Alumunium (Metallic Neon)": "A grand architectural mosque constructed from orderly, industrial-grade aluminum plates and recycled metallic structures. The dome and minarets feature elegant embossed Arabic calligraphy illuminated by pulsing RGB neon lights. The structure stands as a real-world majestic building under a clear night sky, with its metallic walls reflecting vibrant neon glows. The spacious courtyard is filled with artistic metallic wire sculptures and paths of shimmering silver ore. Captured with a professional wide-angle architectural lens from a human eye-level perspective to show its impressive but realistic scale, maintaining perfect architectural integrity and realistic proportions without any miniature or diorama elements.",                "Kristal Botol (Aquatic Glow)": "A monumental architectural diorama mosque constructed from massive, orderly layers of clear recycled plastic bottles, presented as a large-scale museum exhibit. The colossal structure features gold calligraphy on its transparent surfaces, with vibrant blue and cyan LED lights refracting through the gigantic crystalline walls. The vast yard is decorated with large shards of clear plastic resembling blocks of ice and grand LED-lit fountains. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive bottle-structures look like colossal crystalline architecture while maintaining perfect architectural integrity.",
                "Campuran Kayu & LED RGB": "A monumental architectural diorama mosque constructed from massive, interwoven recycled wood structures, presented as a large-scale museum exhibit. The colossal building features intricate gold Arabic calligraphy around the gigantic dome and vibrant multi-color LED strips glowing intensely from the large windows. The vast yard is decorated with stone gravel paths and grand street lamps. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive wooden elements look like colossal timber architecture while maintaining perfect architectural integrity.",
                "Akrilik & Logam (Neon Glow)": "A monumental architectural diorama mosque constructed from massive, pristine clear acrylic panels and heavy scrap metal structures, presented as a large-scale museum exhibit. The colossal modern structure features gigantic sandblasted calligraphy on the walls and pulsing RGB LED lights that illuminate the huge interior. The vast yard is decorated with large silver boulders and grand glowing LED bushes. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive acrylic and metal elements look like colossal futuristic architecture while maintaining perfect architectural integrity.",
                "Bambu & Batok Kelapa (Vibrant LED)": "A monumental architectural diorama mosque constructed from massive, intricate woven bamboo structures and large polished coconut shell panels, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic hand-painted gold calligraphy and vibrant colorful LED installations tracing the huge arches. The vast yard is decorated with natural landscape moss and high bamboo perimeter walls. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive bamboo and coconut elements look like colossal traditional architecture while maintaining perfect architectural integrity.",
                "Stik Es Krim & Kristal (Rainbow LED)": "A monumental architectural diorama mosque constructed from massive, orderly structural wooden planks resembling gigantic ice cream sticks, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic embossed gold calligraphy and rainbow LED lighting glowing through large crystal-bead windows. The vast yard is decorated with white sand and grand flower gardens. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive ice-cream stick and crystal elements look like colossal playful architecture while maintaining perfect architectural integrity.",
                "Kardus & Barang Bekas (Electric Glow)": "A monumental architectural diorama mosque constructed from massive, orderly layers of recycled industrial cardboard and heavy electronics, presented as a large-scale museum exhibit. The colossal industrial structure features gigantic glowing neon calligraphy and towering multi-colored fiber optic light installations on the minarets. The vast yard is decorated with large colorful wire sculptures and monumental metallic structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive cardboard and electronic elements look like colossal cyberpunk architecture while maintaining perfect architectural integrity.",
                "Pelangi (Rainbow Village)": "A monumental architectural diorama mosque constructed from massive, orderly structural elements painted in vibrant, cheerful rainbow colors, presented as a large-scale museum exhibit. The colossal traditional structure features multiple gigantic domes and huge windows illuminated with powerful LED installations. The vast yard is decorated with large colorful boulders and monumental animal-themed sculptures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive colorful elements look like colossal playful architecture while maintaining perfect architectural integrity.",
                "Kerajaan Awan (Cloud Kingdom)": "A monumental architectural diorama mosque constructed from massive, intricate fantasy realms, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic fluffy cloud resembling structural materials and ethereal textures. Features huge star and moon shaped windows. The vast yard is decorated with large glowing crystalline stars and monumental cloud-like formations. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive cloud and crystal elements look like colossal celestial architecture while maintaining perfect architectural integrity.",
                "Kastil Balok (Block Castle)": "A monumental architectural diorama mosque constructed from massive, orderly interlocking colorful gigantic structural building blocks, presented as a large-scale museum exhibit. The colossal industrial structure features towering blocky minarets and a gigantic central dome constructed from huge interlocking architectural bricks. The vast yard is decorated with monumental block-shaped sculptures and full-sized futuristic vehicles. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive colorful block and brick elements look like colossal playful architecture while maintaining perfect architectural integrity.",
                "Lego Warna-Warni (Brick Paradise)": "A monumental architectural diorama mosque constructed entirely from massive, interlocking colorful LEGO bricks, presented as a large-scale museum exhibit. The colossal structure features intricate brick-built Arabic calligraphy and a gigantic central dome made of thousands of glossy, vibrant bricks in red, blue, yellow, green, and orange. Powerful RGB LED strips are integrated within the structure, glowing intensely through translucent brick windows and tracing the towering minarets, creating a spectacular multi-color pulsing light show against the moody stormy-overcast sky background. The vast yard is decorated with monumental block-shaped sculptures, LEGO trees, and high-detailed futuristic vehicles. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive LEGO elements look like colossal playful architecture while maintaining perfect architectural integrity.",
                "Kulit Jeruk & Buah (Citrus Fresh)": "A monumental architectural diorama mosque constructed from massive, orderly Sun-dried organic plates resembling gigantic citrus zest, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic intricate patterns carved into the monumental facade with powerful LED installations glowing intensely from the huge interior. The vast yard is decorated with monumental spice-shaped sculptures and high aromatic timber perimeter walls. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive citrus and spice elements look like colossal organic architecture while maintaining perfect architectural integrity.",
                "Batok Kelapa & Nanas (Tropical Fruit)": "A monumental architectural diorama mosque constructed from massive, orderly Polished coconut shell structures and gigantic textured organic plates resembling pineapple skins, presented as a large-scale museum exhibit. The colossal tropical structure features gigantic textured golden dome and powerful green LED installations. The vast yard is decorated with monumental exotic stone seeds and grand architectural bamboo bridges. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive coconut and pineapple elements look like colossal tropical architecture while maintaining perfect architectural integrity.",
                "Kulit Semangka (Eco-Green)": "A monumental architectural diorama mosque constructed from massive, orderly Emerald-green watermelon rinds resembling structural walls, presented as a large-scale museum exhibit. The colossal bio-architectural structure features gigantic arched windows with powerful glowing emerald LED installations from the huge interior. The vast yard is decorated with large stone boulders and monumental architectural water lily lakes. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive watermelon elements look like colossal organic architecture while maintaining perfect architectural integrity.",
                "Emas & Marmer (Royal Palace)": "A monumental architectural diorama royal mosque constructed from massive, orderly gold-plated structural segments and monumental polished white marble slabs, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic 24k gold leaf calligraphy and huge emerald-encrusted windows. The vast yard is made of smooth obsidian stone with grand golden fountain installations and towering cypress trees. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive gold and marble elements look like colossal royal architecture while maintaining perfect architectural integrity.",
                "Kristal & Berlian (Diamond Glow)": "A monumental architectural diorama mosque constructed from massive, orderly Swarovski-style crystalline structures and monumental silver filigree work, presented as a large-scale museum exhibit. The colossal traditional structure features powerful blue LED installations that refract through gigantic glass facets. The vast yard is decorated with crushed diamond-like sand and monumental crystal floral sculptures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive crystal and silver elements look like colossal diamond architecture while maintaining perfect architectural integrity.",
                "Kayu Jati & Gading (Imperial Heritage)": "A monumental architectural diorama mosque constructed from massive, orderly Dark aged teak wood structures and gigantic ivory-white inlays, presented as a large-scale museum exhibit. The colossal imperial structure features huge hand-carved Arabic motifs and powerful warm amber LED backlighting. The vast yard is covered in premium velvet-textured landscape with high silver-plated perimeter walls. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive wood and ivory elements look like colossal heritage architecture while maintaining perfect architectural integrity.",
                "Safir & Platinum (Futuristic Luxury)": "A monumental architectural diorama mosque constructed from massive, orderly Platinum-finished metal segments and gigantic deep sapphire-colored glass panels, presented as a large-scale museum exhibit. The colossal futuristic structure features powerful glowing neon-white LED installations along the huge arches and domes. The vast yard is decorated with large polished chrome boulders and monumental futuristic glass tree structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive sapphire and platinum elements look like colossal futuristic architecture while maintaining perfect architectural integrity.",
                "Serabut Kelapa & LED Rainbow (Rustic-Neon)": "A monumental architectural diorama mosque constructed from massive, orderly woven golden-brown coconut fiber structures, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic gold calligraphy and vibrant multi-color LED installations (Cyan, Magenta, and Lime) glowing intensely through the huge fibrous walls. The vast yard is decorated with large white sea shell paths and high bamboo perimeter walls. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive coconut fiber elements look like colossal rustic-neon architecture while maintaining perfect architectural integrity.",
                "Mosaik Kulit Buah & LED Glow (Citrus Imperial)": "A monumental architectural diorama mosque featuring massive, orderly mosaic patterns constructed from gigantic dried orange and lemon peel segments, presented as a large-scale museum exhibit. The colossal imperial structure features powerful emerald-green LED installations glowing intensely from the huge arched windows and monumental gold-leaf details on the minarets. The vast yard is decorated with large star-shaped stone sculptures and grand aromatic timber structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive citrus peel elements look like colossal organic-imperial architecture while maintaining perfect architectural integrity.",
                "Kelopak Bunga & LED Sapphire (Floral Majesty)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments resembling deep-red rose petals, presented as a large-scale museum exhibit. The colossal floral structure features powerful sapphire-blue LED installations hidden intensely within the gigantic floral layers for a mystical glow and monumental gold-embossed calligraphy. The vast yard is made of smooth black stone boulders and grand jasmine-themed floral sculptures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive floral elements look like colossal mystical-floral architecture while maintaining perfect architectural integrity.",
                "Batok Kelapa & LED Crystal (Tropical Diamond)": "A monumental architectural diorama mosque constructed from massive, orderly heavy, polished dark coconut shell structures, presented as a large-scale museum exhibit. The colossal tropical structure features gigantic domes with sparkling rainbow LED fiber optics that create a huge starry effect and monumental gold-painted calligraphy. The vast yard is decorated with white sand and towering architectural palm tree structures made of high-grade fiber. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive coconut and crystal elements look like colossal tropical-diamond architecture while maintaining perfect architectural integrity.",
                "Daun Kering (LED Warm)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments resembling dried organic leaves, presented as a large-scale museum exhibit. The colossal organic structure features powerful warm LED installations integrated intensely into the gigantic structure. The vast yard is decorated with grand dry grass landscapes, large stone boulders, and high wooden perimeter walls. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive dried leaf elements look like colossal rustic-warm architecture while maintaining perfect architectural integrity.",
                "Kayu (LED Amber)": "A monumental architectural diorama mosque constructed from massive, orderly woven bamboo structures, presented as a large-scale museum exhibit. The colossal traditional structure features powerful amber-colored LED installations inside, casting huge dramatic shadows through the gigantic fibrous walls. The vast yard features monumental ancient trees and a grand stone-paved pathway leading to the gigantic entrance. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive bamboo elements look like colossal rustic-amber architecture while maintaining perfect architectural integrity.",
                "Daun Pisang (Traditional)": "A monumental architectural diorama mosque crafted from massive, orderly structural segments resembling fresh and dried banana leaves, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic organic green and brown textures, decorated with powerful yellow LED installations inside glowing intensely through the huge leaf-like walls. The vast yard features towering banana tree structures and high bamboo perimeter walls on a monumental mossy green landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive banana leaf elements look like colossal organic-traditional architecture while maintaining perfect architectural integrity.",
                "Buah Melon (Carved Art)": "A monumental architectural diorama mosque featuring massive, orderly structural walls with the gigantic textured rind patterns of a green melon, presented as a large-scale museum exhibit. The colossal bio-architectural structure features glowing with powerful lime-green LED installations intensely from the huge interior. The vast courtyard is decorated with monumental floral stone carvings and a grand mint-green reflection lake. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive melon elements look like colossal bio-carved architecture while maintaining perfect architectural integrity.",
                "Buah Naga (Exotic Pink)": "A monumental architectural diorama mosque featuring massive, orderly structural walls with the gigantic vibrant pink scale-textured facade of a dragon fruit, presented as a large-scale museum exhibit. The colossal tropical structure features powerful magenta LED installations that highlight the monumental scale-like textures. The vast yard features gigantic exotic botanical structures and huge stretches of pinkish sand. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive dragon fruit elements look like colossal exotic-pink architecture while maintaining perfect architectural integrity.",
                "Koran Bekas (Paper Craft)": "A monumental architectural diorama mosque built from massive, orderly structural segments of recycled newsprint textures, presented as a large-scale museum exhibit. The colossal industrial structure shows gigantic hints of printed typography across its monumental facade, illuminated by powerful RGB LED installations glowing intensely. The vast yard features towering paper-textured tree structures and grand architectural benches made of massive structural cardboard. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive newspaper elements look like colossal cyberpunk-paper architecture while maintaining perfect architectural integrity.",
                "Pecahan Kaca (Mosaic)": "A monumental architectural diorama mosque constructed from massive, orderly shimmering mosaic glass panels, presented as a large-scale museum exhibit. The colossal crystal structure features powerful cool-blue and white LED installations that create a gigantic sparkling crystalline effect intensely across the monumental facade. The vast yard is decorated with large translucent glass boulders and a grand mirror-surfaced floor area. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive glass elements look like colossal mosaic-crystal architecture while maintaining perfect architectural integrity.",
                "Botol Bekas (Recycled Plastic)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of translucent recycled polymers and gigantic geometric cap-inspired elements, presented as a large-scale museum exhibit. The colossal industrial structure features glowing intensely with powerful, vibrant multi-color RGB LED installations that shine through the huge plastic facades. The vast courtyard is decorated with monumental colorful floral sculptures and grand emerald-green synthetic landscapes. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive plastic elements look like colossal cyberpunk-recycled architecture while maintaining perfect architectural integrity.",
                "Kristal (LED Neon)": "A monumental architectural diorama mosque constructed from massive, orderly glistening crystalline structures, presented as a large-scale museum exhibit. The colossal traditional structure features powerful neon blue and purple LED installations intensely glowing through the huge glass-like walls. The vast base is decorated with large crystal boulders and a grand glass-surfaced reflection lake. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive crystal elements look like colossal diamond-neon architecture while maintaining perfect architectural integrity.",
                "Pasir (Sand Art)": "A monumental architectural diorama mosque sculpted entirely from massive, orderly amounts of fine golden sand, presented as a large-scale museum exhibit. The colossal traditional structure features gigantic smooth domes and monumental architectural edges, glowing intensely with powerful amber LED installations. The vast yard is a serene monumental desert landscape with large raked sand patterns and huge desert boulders. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive sand elements look like colossal sand-carved architecture while maintaining perfect architectural integrity.",
                "Bunga Matahari (Yellow Glow)": "A monumental architectural diorama mosque entirely covered in massive, orderly gigantic vibrant yellow sunflower petals, presented as a large-scale museum exhibit. The colossal floral structure features massive dome with the dark seeded textures of a sunflower center, glowing intensely with powerful golden-yellow LED installations. The vast courtyard is decorated with monumental sunflower-themed floral structures and a grand yellow-stone architectural pathway. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive sunflower elements look like colossal yellow-flowered architecture while maintaining perfect architectural integrity.",
                "Jerami (Rustic Straw)": "A monumental architectural diorama mosque constructed from massive, orderly woven golden straw and hay structures, presented as a large-scale museum exhibit. The colossal rustic structure features gigantic intricate patterns with powerful warm yellow LED installations flickering intensely inside. The vast yard features monumental haystack structures, high wooden perimeter walls, and a grand rustic atmosphere. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive straw elements look like colossal rustic-straw architecture while maintaining perfect architectural integrity.",
                "Roti (Bread Craft)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of various baked bread and gigantic golden-brown crust panels, presented as a large-scale museum exhibit. The colossal traditional structure features glowing intensely with powerful warm orange LED installations from the huge windows. The vast courtyard is decorated with grand golden-grain pathways and monumental flour-dusted botanical structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive bread elements look like colossal baked-bread architecture while maintaining perfect architectural integrity.",
                "Buah Jeruk (Citrus Fresh)": "A monumental architectural diorama mosque crafted from massive, orderly structural segments of bright orange citrus peels and gigantic dried orange-slice windows, presented as a large-scale museum exhibit. The colossal structure glows with powerful orange and lime-green LED installations intensely. The vast yard features towering citrus-themed botanical structures and large orange-colored stone boulders. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive citrus elements look like colossal organic architecture.",
                "Serut Kayu (Wood Shavings)": "A monumental architectural diorama mosque featuring massive, orderly structural segments made of gigantic curly light-colored timber shavings, presented as a large-scale museum exhibit. The colossal building is illuminated by powerful amber LED installations glowing through the huge curly textures. The vast courtyard is decorated with grand architectural wooden benches, monumental pine tree structures, and a huge textured timber-dust landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Cangkang Telur (Mosaic Shell)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of white and brown eggshell mosaic panels, presented as a large-scale museum exhibit. The colossal structure glows with powerful white LED installations reflecting off the eggshell textures. The vast yard features grand white stone-paved pathways and monumental botanical structures set in gigantic architectural containers. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Bunga & Daun (Floral Garden)": "A monumental architectural diorama mosque intricately covered in massive, orderly installations of colorful blooming flowers and gigantic fresh green leaves, presented as a large-scale museum exhibit. The colossal floral building glows with powerful multi-color RGB LED installations. The vast yard features a monumental floral archway, grand green landscapes, and a huge stone-paved pathway. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Kayu Jati & Daun (Forest Rustic)": "A monumental architectural diorama mosque built from massive, orderly dark polished teak wood structures accented with gigantic fresh green leaf patterns on the dome, presented as a large-scale museum exhibit. The colossal rustic structure is illuminated by powerful warm amber LED installations. The vast courtyard is decorated with monumental teak timber structures, large mossy boulders, and huge prehistoric forest ferns. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Bambu & Janur (Traditional Art)": "A monumental architectural diorama mosque constructed from massive, orderly yellow bamboo pillars and gigantic woven young coconut leaf (janur) segments, presented as a large-scale museum exhibit. The colossal traditional structure glows with powerful yellow LED installations through the intricate weaving. The vast yard is decorated with monumental 'penjor' installations and a high architectural bamboo perimeter wall. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Batu Kali & Lumut (Nature Zen)": "A monumental architectural diorama mosque constructed from massive, orderly river stone boulders and gigantic patches of natural green moss, presented as a large-scale museum exhibit. The colossal nature-themed structure features powerful cool white LED installations glowing from the huge windows. The vast yard features a monumental flowing river stream and towering pine tree structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Kulit Jagung & Biji-bijian (Harvest)": "A monumental architectural diorama mosque crafted from massive, orderly structural segments of dried corn husks and gigantic mosaic patterns made of various seeds, presented as a large-scale museum exhibit. The colossal harvest structure glows with powerful warm orange LED installations. The vast yard features monumental harvest structures and towering scarecrow-themed statues on a huge grain-textured landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Perca Kain & Benang (Textile Craft)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of batik fabric patterns and gigantic yarn embroidery installations, presented as a large-scale museum exhibit. The colossal structure glows with powerful RGB LED lights intensely from the huge interior. The vast courtyard is decorated with monumental floral textile sculptures and grand architectural seating structures on a monumental felt-textured landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Pelepah Pisang & Lidi (Village Vibes)": "A monumental architectural diorama mosque constructed from massive, orderly dried banana midrib structures and gigantic coconut leaf stick (lidi) installations, presented as a large-scale museum exhibit. The colossal rustic structure glows intensely with powerful warm amber LED lights through the huge fibrous walls. The vast yard features monumental traditional pavilion structures and huge clay-formed architectural vessels. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions.",
                "Donat (Glazed & Sprinkle)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of stacked glazed donut forms with gigantic colorful sprinkles and glossy icing textures, presented as a large-scale museum exhibit. The colossal dessert structure glows with powerful warm pink LED installations intensely. The vast courtyard is decorated with monumental spherical botanical structures and a grand sugar-powdered architectural pathway. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and delicious textures.",
                "Permen Warna-Warni (Hard Candy)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of colorful hard candies and gigantic lollipop-inspired pillars, presented as a large-scale museum exhibit. The colossal structure features a monumental glossy crystalline texture that reflects powerful multi-color RGB LED installations intensely. The vast yard features high candy-cane architectural barriers and a grand rainbow-textured landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and crystal-like reflections.",
                "Permen Yupi (Gummy Texture)": "A monumental architectural diorama mosque crafted from massive, orderly structural segments of various translucent gummy materials and gigantic gelatinous forms, presented as a large-scale museum exhibit. The colossal gummy building glows intensely with powerful RGB LED installations shining through the huge translucent facades. The vast yard features towering gummy-textured tree structures and a monumental soft-textured landscape base. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and wobbly textures.",
                "Jelly & Puding (Translucent)": "A monumental architectural diorama mosque constructed from massive, orderly translucent colorful jelly-like segments and gigantic structural pudding blocks, presented as a large-scale museum exhibit. The colossal wobbling structure features powerful neon LED installations glowing beautifully through the huge translucent facades. The vast courtyard is decorated with large translucent crystal-like boulders and a grand syrup-textured reflection lake. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and aquatic glow.",
                "Cokelat & Biskuit (Choco-Art)": "A monumental architectural diorama mosque constructed from massive, orderly dark and milk chocolate structural segments with gigantic biscuit-textured roofing, presented as a large-scale museum exhibit. The colossal cocoa structure glows intensely with powerful golden LED installations. The vast courtyard features monumental wafer-styled architectural benches and huge cocoa-powdered mountain landscapes. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and matte chocolate textures.",
                "Marshmallow (Soft Cloud)": "A monumental architectural diorama mosque constructed from massive, orderly white and pastel structural segments with gigantic marshmallow-like textures, presented as a large-scale museum exhibit. The colossal soft structure glows with powerful ethereal RGB LED installations intensely. The vast yard is decorated with towering cotton-candy botanical structures and a huge white sugar-sand landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and soft, cloud-like proportions.",
                "Menara Kaleng (Industrial Majesty)": "A monumental architectural diorama industrial mosque constructed from massive, orderly stacked silver metallic cylinders and gigantic domes made of structural translucent segments, presented as a large-scale museum exhibit. The colossal structure features huge gold-leaf calligraphy and powerful emerald-green LED installations glowing intensely through the massive gaps. The vast yard is decorated with monumental metallic gears and large copper structural elements. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and industrial-heroic proportions.",
                "Lampion Plastik (Rainbow Recycle)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of colorful translucent polymers and gigantic geometric recycled elements, presented as a large-scale museum exhibit. Powerful rainbow LED installations transform the monumental structure into a gigantic glowing lantern. The vast yard is decorated with grand multi-color stone-paved pathways and high architectural perimeter walls. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and glowing-lantern effect.",
                "Macaroon (Elegant Pastel)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of stacked colorful macaroon-inspired disks, presented as a large-scale museum exhibit. The colossal structure features monumental pastel-toned facades and powerful warm white LED installations glowing intensely. The vast courtyard is decorated with grand botanical sculptures with cream-like textures and a huge pastel-tiled architectural pathway. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and elegant dessert proportions.",
                "Biji Kopi (Dark Aroma)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of dark roasted coffee bean textures, presented as a large-scale museum exhibit. The colossal building features a monumental rich brown facade and powerful warm orange LED installations glowing through the bean-textured walls. The vast courtyard is decorated with monumental architectural storage structures and grand dark-toned stone-paved pathways. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and aromatic-dark textures.",
                "Bungkus Snack (Snack Wrap Art)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments made of colorful recycled snack packaging, presented as a large-scale museum exhibit. The colossal facade is a vibrant mosaic of yellow, red, and blue wrappers with gigantic brand graphics, illuminated by a powerful, dynamic multi-color RGB LED installation creating a spectacular glowing kaleidoscope effect. The vast yard features monumental reflective botanical structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and vibrant pop-art textures.",
                "Sabun (Crystal Soap Art)": "A monumental architectural diorama mosque constructed from massive, orderly translucent soap segments resembling giant colorful gemstones, presented as a large-scale museum exhibit. The colossal structure features vibrant green, blue, and purple crystalline textures, glowing with dynamic RGB LED lights that create shifting, multi-color internal reflections throughout the monumental facade. The vast yard is decorated with gemstone-styled sculptures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and wobbly-gemstone textures.",
                "Karet Gelang (Elastic Rubber Art)": "A monumental architectural diorama mosque constructed from massive, orderly intertwined networks of gigantic colorful rubber bands, presented as a large-scale museum exhibit. The colossal structure features intricate, stretched elastic textures and complex geometric patterns, glowing intensely with powerful dynamic multi-color RGB LED lights woven through the rubber structure. The vast yard features monumental rubber-sculpture art. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and hyper-detailed elastic proportions.",
                "Masjid Rujak Buah (Tropical Harvest)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of various tropical fruits, presented as a large-scale museum exhibit. The colossal dome is made from a gigantic, hollowed-out vibrant orange papaya with its dark seeds acting as intricate structural ornaments, while the minarets are crafted from stacked, polished pink guavas and gigantic deep-purple grapes. The facade features translucent slices of starfruit (belimbing) as majestic windows, glowing intensely with powerful lime-green and warm amber LED installations from the huge interior. The vast yard is decorated with monumental watermelon-rind boulders and grand architectural pathways made of dried citrus seeds. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and juicy organic textures, making the massive fruit elements look like colossal celestial architecture while maintaining perfect architectural integrity.",
                "Pepaya (Orange Oasis)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of vibrant orange papaya flesh, presented as a large-scale museum exhibit. The colossal dome is a gigantic hollowed papaya with its dark, glistening seeds acting as intricate architectural ornaments on the ceiling. Powerful warm amber LED installations glow intensely from within the huge fibrous walls. The vast yard features monumental papaya-seed gravel paths and towering dried-peel structures. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and juicy organic textures.",
                "Belimbing (Star-Light Palace)": "A monumental architectural diorama mosque constructed from massive, orderly translucent slices of starfruit (belimbing), presented as a large-scale museum exhibit. The colossal structure features gigantic star-shaped windows that create a breathtaking geometric facade. Powerful lime-green and golden LED installations glow through the huge starfruit segments, creating a spectacular glowing effect. The vast yard is decorated with monumental star-shaped stone sculptures and grand architectural bridges. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and perfect star-geometry.",
                "Anggur (Purple Crystal)": "A monumental architectural diorama mosque constructed from massive, orderly clusters of gigantic deep-purple and emerald-green grapes, presented as a large-scale museum exhibit. The colossal domes are made of huge, polished spherical grape forms that resemble translucent gemstones. Powerful violet and white LED installations glow intensely from the huge interior, refracting through the grape skins. The vast yard features monumental vine-shaped architectural structures and grand polished-seed pathways. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and jewel-like textures.",
                "Durian (Spiky Fortress)": "A monumental architectural diorama mosque constructed from massive, orderly segments of thorny durian husks, presented as a large-scale museum exhibit. The colossal structure features gigantic golden-yellow interior walls with the creamy texture of durian fruit. Powerful warm yellow LED installations highlight the monumental spiky facade and the huge arched entrances. The vast yard is decorated with large thorn-shaped sculptures and grand architectural timber paths. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and aggressive-heroic textures.",
                "Manggis (Imperial Purple)": "A monumental architectural diorama mosque featuring a massive, orderly deep-purple thick rind exterior and gigantic white segments of mangosteen fruit as the central dome, presented as a large-scale museum exhibit. Powerful cool-white LED installations glow from the huge interior, illuminating the pristine white fruit-flesh architecture. The vast yard is decorated with monumental purple-stone boulders and grand flower-shaped architectural petals. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and regal-imperial textures.",
                "Ijuk (Rustic-Traditional)": "A monumental architectural diorama mosque constructed from massive, orderly woven black sugar palm fiber (ijuk) structures, presented as a large-scale museum exhibit. The colossal traditional building features intricate ijuk-weaving patterns and gigantic wooden elements. Powerful warm amber LED installations glow intensely through the huge fibrous walls. The vast yard features monumental thatch-roofed traditional pavilions and high bamboo perimeter walls on a monumental dry-earth landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive ijuk elements look like colossal rustic architecture.",
                "Padi (Golden Harvest)": "A monumental architectural diorama mosque crafted from massive, orderly structural segments made of gigantic dried rice stalks (padi), presented as a large-scale museum exhibit. The colossal golden structure features gigantic textured walls and huge arched entrances, glowing with powerful warm orange LED installations. The vast yard features monumental harvest structures and towering scarecrow-themed statues on a huge grain-textured landscape. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and golden-harvest textures, making the massive padi elements look like colossal celestial architecture.",
                "Beras (Pristine White)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of pristine white rice grains, presented as a large-scale museum exhibit. The colossal pure-white building features smooth domes and monumental architectural edges made of millions of rice grains. Powerful cool white LED installations glow intensely from within the huge interior, reflecting off the rice textures. The vast yard is decorated with large stone boulders and grand architectural pathways made of dried rice seeds. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and pristine textures, making the massive rice elements look like colossal snow-white architecture.",
                "Kacang Ijo (Lime-Green Glow)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments made of gigantic polished green mung bean (kacang ijo) elements, presented as a large-scale museum exhibit. The colossal bio-architectural building features glowing with powerful lime-green LED installations intensely from the huge interior. The vast courtyard is decorated with monumental floral stone carvings and a grand mint-green reflection lake. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and wobbly-gemstone textures, making the massive mung bean elements look like colossal bio-carved architecture.",
                "Kacang Merah (Deep-Red Earth)": "A monumental architectural diorama mosque constructed from massive, orderly structural segments of deep-red kidney bean (kacang merah) textures, presented as a large-scale museum exhibit. The colossal traditional building features a monumental rich red facade and powerful warm amber LED installations glowing through the huge bean-textured walls. The vast yard features monumental architectural storage structures and grand dark-toned stone-paved pathways. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and dark-earth textures, making the massive kidney bean elements look like colossal heroic architecture.",
                "Kristal & Berlian (Diamond Glow)": "A monumental architectural diorama mosque constructed from massive, orderly Swarovski-style crystalline structures and monumental silver filigree work, presented as a large-scale museum exhibit. The colossal traditional structure features powerful multi-color RGB LED installations that refract through gigantic crystal facets, creating a spectacular glowing kaleidoscope effect intensely. Captured with a low-angle macro cinematic lens.",
                "Akrilik & Kaca (Modern Glow)": "A monumental architectural diorama mosque constructed from massive, orderly clear and sandblasted acrylic panels, presented as a large-scale museum exhibit. Powerful RGB LED strips are integrated within the huge panel gaps, turning the colossal structure into a gigantic modern light installation. Captured with a low-angle macro cinematic lens.",
                "Es & Salju (Frozen Aurora)": "A monumental architectural diorama mosque sculpted from massive amounts of pure clear ice and packed snow, presented as a large-scale museum exhibit. Powerful dynamic multi-color RGB LED installations glow intensely within the gigantic icy domes, creating shifting, magical light effects like an aurora borealis against the cloudy sky. Captured with a low-angle macro cinematic lens.",
                "Permen Yupi (Gummy Texture)": "A monumental architectural diorama mosque crafted from massive, orderly structural segments of various translucent gummy materials and gigantic gelatinous forms, presented as a large-scale museum exhibit. Powerful RGB LED installations glow intensely through the huge gummy facades, creating a spectacular wobbly light show. Captured with a low-angle macro cinematic lens.",
                "Logam & Krom (Cyber-Neon)": "A monumental architectural diorama mosque constructed from massive, orderly polished chrome segments, presented as a large-scale museum exhibit. Powerful dynamic neon-white and purple LED installations on the yard reflect intensely off the colossal mirror-like facade. Captured with a low-angle macro cinematic lens.",
                "Botol Plastik (Recycled Glow)": "A monumental architectural diorama mosque constructed from massive, orderly layers of translucent recycled plastic bottles and gigantic water gallon containers, presented as a large-scale museum exhibit. Powerful multi-color RGB LED installations glow intensely from within the huge plastic structures, turning the colossal building into a gigantic glowing lantern. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and recycled-crystal textures.",
                "Kaleng Bekas (Industrial Neon)": "A monumental architectural diorama mosque constructed from massive, orderly stacked recycled tin cans and heavy scrap metal cylinders, presented as a large-scale museum exhibit. The colossal structure features powerful neon-purple and lime-green LED installations glowing through the huge gaps between the metallic cylinders, creating a gritty cyberpunk atmosphere. Captured with a low-angle macro cinematic lens to emphasize its heroic-industrial scale.",
                "Elektronik Bekas (Cyber-Relic)": "A monumental architectural diorama mosque constructed from massive layers of recycled circuit boards, tangled wires, and gigantic electronic components, presented as a large-scale museum exhibit. Powerful dynamic RGB LED installations trace the huge electronic paths, creating a pulsing 'living machine' light effect across the colossal facade. Captured with a low-angle macro cinematic lens to emphasize its titanic digital-ruin textures.",
                "Sedotan Plastik (Neon Pipe Art)": "A monumental architectural diorama mosque constructed from millions of massive, orderly intertwined colorful plastic straws, presented as a large-scale museum exhibit. The colossal structure features powerful RGB LED installations glowing through the huge transparent straw-tubes, creating a spectacular linear light show. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and complex geometric textures.",
                "Kepingan CD & Tutup Botol (Rainbow Junk)": "A monumental architectural diorama mosque constructed from massive, orderly mosaic patterns of recycled CDs and colorful plastic bottle caps, presented as a large-scale museum exhibit. The colossal facade creates an intense iridescent shimmering effect as powerful RGB LED installations reflect off the huge metallic surfaces. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and dazzling pop-art reflections."
            },
            # --- 3. MASTER KONTEN (🌍 WORLD MOSQUE DIORAMA - MEGA SCALE EDITION) ---
            "🌍 Diorama Masjid": {
                "Kota Botol & Kaleng (Recycled City)": "A sprawling monumental architectural diorama constructed from massive, orderly layers of recycled plastic bottles and gigantic geometric soda can-inspired elements, presented as a large-scale museum exhibit. The colossal traditional structure features glowing intensely with powerful, vibrant multi-color RGB LED installations that shine through the huge plastic and metallic facades, creating a spectacular futuristic 'Cyberpunk' village vibe. The scene includes tiny roads made of massive black rubber and monumental plastic-cap street lamps. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and recycled-crystal textures, making the massive bottle and can elements look like colossal cyberpunk-city architecture while maintaining perfect architectural integrity.",                "Lembah Hijau & Sungai (LED RGB)": "A grand miniature mosque in a lush valley with rolling hills and a flowing crystal-clear resin river. The yard features glowing RGB LED strips along the tiny stone bridges, miniature flower gardens, and small pine trees reflecting in the water.",
                "Masjidil Haram (Ka'bah & Mewah)": "A monumental architectural diorama of Masjidil Haram, presented as a large-scale museum exhibit. The colossal Ka'bah is at the center with a gigantic, meticulously draped real black cloth, adorned with sparkling white crystal tiles and warm gold LED calligraphy. The vast marble courtyard (Mataf) is brightly illuminated with thousands of cold-white LED lights, featuring tiny miniature pilgrims walking around the complex. The towering minarets have glowing green tips. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and heroic proportions, making the massive elements look like colossal royal architecture.",
                "Masjid Nabawi (Payung & Green Dome)": "A monumental architectural diorama of Masjid Nabawi, presented as a large-scale museum exhibit. The grand building features its famous Green Dome brightly lit, with the iconic courtyard umbrellas open and tracing their edges with powerful warm white LED strips. The colossal complex is decorated with gigantic miniature palm trees and hundreds of tiny LED street lamps along the vast marble paths. The overall atmosphere glows intensely with dynamic lighting, creating a spectacular spiritual-vibrant vibe. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and regal-traditional proportions.",
                "Masjid Al-Aqsa (Dome of the Rock)": "A stunning detailed monumental architectural diorama of the Dome of the Rock (Qubbat as-Sakhra), presented as a large-scale museum exhibit. The colossal structure features its magnificent gold dome shimmering intensely under powerful warm-white LEDs. The complex is surrounded by gigantic ancient miniature olive trees and tiny stone pathways on a rocky base, featuring subtle amber LED accent lights throughout the massive facades. Captured with a low-angle macro cinematic lens to emphasize its titanic scale and historic-celestial proportions.",
                "Kabah (Mystical Diamond Glow)": "A monumental architectural diorama of the Ka'bah, presented as a large-scale museum exhibit. The colossal structure is built from massive, orderly layers of deep-black Kiswah-style cloth segments that shimmer with integrated tiny diamond-like crystalline fibers, making the entire black surface sparkle intensely. The entire perimeter features gigantic, raised 24k gold calligraphy that seems to float just above the sparkling surface. Thousands of integrated dynamic warm-white and cool-blue LED lights are woven within the massive gold elements and the crystalline fibers, creating a breathtaking pulsing light show that makes the entire structure glow mystical and celestial. Captured with a low-angle macro cinematic lens executing a slow, deep orbital tracking shot, making the massive Ka'bah structure look heroic, titanic, and utterly breathtaking while maintaining perfect architectural integrity within the mystical exhibit space.",
                "Kabah (Mystical Diamond & Pilar Glow)": "A monumental architectural diorama of the Ka'bah, presented as a large-scale museum exhibit. The colossal structure is built from massive, orderly layers of deep-black Kiswah-style cloth segments that shimmer intensely with integrated tiny diamond-like crystalline fibers, making the entire black surface sparkle intensely. It features gigantic, raised 24k gold calligraphy that seems to float just above the sparkling surface. Thousands of integrated dynamic warm-white and cool-blue LED lights are woven within the massive gold elements and the crystalline fibers, creating a breathtaking pulsing light show. The Ka'bah is surrounded by hundreds of towering, massive polished white marble columns that form complex, deep-set concentric arcades, presented as an intricate architectural diorama. Dynamic cool-white and subtle gold LED installations illuminate the huge interior of the arcades and reflect intensely off the colossal marble complex. Captured with a low-angle macro cinematic lens executing a slow, deep orbital tracking shot, making the massive Ka'bah and pillar structures look heroic, titanic, and utterly breathtaking while maintaining perfect architectural integrity within the mystical exhibit space.",
                "Pasukan Diorama Kabah (Mystic Macro Exhibit)": "A large-scale, hyper-detailed museum diorama exhibit presented as four distinct concentric arcades forming a complete circular arrangement. Derived from images image_10.png, image_11.png, image_12.png, and image_13.png, the display centers around the monumental, polished Kabah derived from image_6.png, maintaining its black surface composed of detailed Kiswah-style cloth segments and the identical gold calligraphy band with integrated LEDs glowing warm-gold. Surrounding the center, four massive, orderly layers of polished white marble columns form complex, deep-set concentric arcades. Each of the four concentric rings is constructed from hundreds of towering pillars derived from the specific materials in image_10.png (Teak Wood), image_11.png (Leaf and Grass), image_12.png (Grass Turf), and image_13.png (Mixed Exotic Fruits). Integrated dynamic cool-white and subtle gold LED installations derived from image_8.png glow intensely through the new pillar materials, turning the monumental complex into a gigantic, mystical light sculpture that reflects intensely off the colossal marble structures and the sparkling Kiswah. Thousands of intricate cool-white LED lights are woven throughout the complex marble arches and the new organic textures, creating a breathtaking linear light show derived from image_8.png. The scene is captured with a low-angle macro cinematic lens executing a slow, deep orbital tracking shot, making the massive central Kaaba bener-bener menonjol and the concentric pillar structures look heroic, titanic, and utterly breathtaking, maintaining perfect architectural integrity within the mystical exhibit space. The focus is deep, rendering all details from the black Kabah to the intricate organic pillar textures and the integrated LEDs with crystal-clear precision. No pilgrims or traditional minarets are visible; the focus is entirely on the monumental glowing Kaaba and the surrounding four concentric pillar structures themselves as a mystical exhibit.",
                ...
                "Terapung di Danau (RGB Reflection)": "Miniature a unique mosque on a wooden platform in a calm lake. The yard is filled with glowing LED lotus flowers and lily pads. The water surface is a dark mirror reflecting the vibrant RGB lights of the mosque architecture.",
                "Diorama Mewah (Kubah Emas & Air Terjun)": "large-scale luxury mosque diorama. The main mosque has a sparkling gold dome and white marble walls with RGB LED lights from the windows. The courtyard features a multi-tiered working fountain with dynamic RGB lighting and miniature white horse-drawn carriages on a paved stone floor. Lush tropical plants decorate the edges.",
                "Diorama Kristal (Refleksi Air & Neon)": "Breathtaking diorama featuring a full crystal mosque that glistens with neon blue and purple LED backlighting. It sits on a large circular mirror-like reflection pool. The garden has miniature crystal trees and tiny fiber-optic lights that sparkle like fireflies.",
                ...
                "Pangkalan Luar Angkasa & Masjid Roket (Space Base)": "Miniature An exciting futuristic diorama with a mosque shaped like a rocket ship on a lunar-surface background made of grey sand and craters. Features neon blue and white LED strips tracing the base and a glowing 'Earth' globe in the distance. The scene includes tiny astronaut figures, lunar rovers, and metallic star decorations.",
