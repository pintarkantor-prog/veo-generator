...
def tampilkan_ai_lab():
    ...
    with t_grandma:
        ...
        MASTER_KONTEN_ALL = {
            "🕌 Miniatur Masjid": {
                "Kaleng Alumunium (Metallic Neon)": "A monumental architectural diorama mosque constructed from massive industrial-grade aluminum plates and gigantic recycled metallic structures. The towering dome and massive minarets feature embossed Arabic calligraphy glowing with pulsing RGB neon. The structure is presented as a large-scale museum exhibit, its huge metallic walls reflecting brilliant neon lights. The vast courtyard contains monumental metallic wire sculptures and paths of shimmering silver ore. Captured with a low-angle macro cinematic lens to emphasize its colossal scale and heroic proportions while maintaining perfect architectural integrity.",
